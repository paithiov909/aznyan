...
RcppExport SEXP _aznyan_read_srt_impl(SEXP fileNameSEXP, SEXP collapseSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_aznyan_read_srt_impl", (DL_FUNC) &_aznyan_read_srt_impl, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_aznyan(DllInfo *dll) {
